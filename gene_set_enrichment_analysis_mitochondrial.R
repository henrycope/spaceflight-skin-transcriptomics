...
#
# Description:
# This script conducts Gene Set Enrichment Analysis (GSEA) on differential gene expression results for mitochondrial pathways only.
#
# Inputs:
# 1. Combined differential gene expression file with symbol annotations.
# 2. Mitochondrial GMT files (gene sets).
#
# Outputs:
...
gmt_dir <- "data/gmt_files_mitochondrial"
gsea_out_fn <- "data/fgsea_combined_mitochondrial.csv"
